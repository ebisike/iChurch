...
<div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">All First Timers</h6>
        </div>
        <div class="card-body">
                    ...
                    <?php
                        ...
                        while($result = $results->getResults())
                        {
                            ...
                            if($result['isRetained']){
                                continue; //skip if the individual has been converted.
                            }
                            echo
                            '
                                <tr class="text-dark">
                                    ...
                                    <td>                                         
                                        <a href="allfirsttimers.php?retain='.$result['phone'].'"><i class="fa fa-check-circle fa-1x text-success"></i></a> | 
                                        <a href="allfirsttimers.php?del='.$result['phone'].'"><i class="fa fa-trash fa-1x text-danger"></i></a> |
                                    </td>
                                </tr>
                            ';
                        }
