...
<div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">All financial (Credit) records of: <?php echo $org->getOrgName($_SESSION['orgId'])?></h6>
        </div>
        <div class="card-body">
            ...
            <table class="table table-striped table-hover" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody class="text-dark">
                    <?php
                        $count = 0;
                        $list = $transaction->getCreditTransactions($_SESSION['orgId']);
