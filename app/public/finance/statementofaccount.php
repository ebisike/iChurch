<?php
    ...
    if(isset($_GET['sd']) && isset($_GET['ed']))
    {
        ...
        $user = new Users();
        $statement = new AccountStatement($data);
...
<div class="pt-0 pl-3 pr-3" id="mReport">
    <div class="card pt-2 pl-5 pr-5 pb-2 border-0 shadow-lg">
        <div class="row p-3">
            <div class="col-md-6">
                ...
                <p><b>Generated By: </b><span><?php echo $fullname.' @'.$username?></span></p>
    ...
    <div class="card border-0 pt-2 pl-5 pr-5 pb-2 shadow-lg">
        ...
        <small class="ml-3 mb-3">click on item row for more details</small>
        <div class="table-responsive">
            <table class="table table-hover table-striped" width="100%" cellspacing="0">
                ...
                <tbody id="income-sourcelist">
                    <?php
                        $summary = $statement->getIncomeSourceSummary();
                        $totalCredits = 0;
        ...
        <div class="table-responsive">
            <table class="table table-hover table-striped" width="100%" cellspacing="0">
                ...
                <tbody id="expenditure-sourcelist">
                    <?php
                        $summary = $statement->getExpenditureSourceSummary();
                        $totalDebits = 0;
                        for ($i=0; $i < count($summary); $i++)
                        {
                            if($summary[$i]['source']==""){
...
<button class="btn btn-primary btn-lg m-3" id="print">print</button>
<?php
